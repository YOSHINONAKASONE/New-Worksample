...
### 重要な3原則
【**継承**】【**カプセル化**】【**ポリモーフィズム**】    
オブジェクト指向設計はこの三つのルールが守られてこそ実現する手法です。 
・実現したい処理(振る舞い)に含まれる①`情報更新に柔軟に対応`できる、その情報と処理をまとめて①`再利用可能`な②`鋳型を作り`、    
それを基に③`多様な開発`ができるような設計手法。①の情報更新に柔軟に対応＝【承継】の原則
このプログラムはAという役割、このプログラムはBという役割、などとカプセルに機能を閉じ込めるイメージで、他のプログラムから干渉されないようにすれば、管理もしやすく
