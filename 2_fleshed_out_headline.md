...
**レッド**と出力される。<div>  </div>    
`naoko_onepiece = Onepiece.new("ブルー")`⇒今度は「Onepiece」という設計図を使い「naoko_onepiece」という    
<span>　　　　　　　　　　　　　　　　　　　　</span>インスタンスオブジェクトを作成。このインスタンスで         `puts(naoko_onepiece.color)`　　　　　　　「ブルー」と指定するだけで上記のクラスに情報が埋め込まれる。    
**ブルー**と出力される。<div>  </div>
